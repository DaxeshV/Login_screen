    ...
    private void checkValidation() {
        ...
        if (getEmailId.trim().length() > 0 && getPassword.trim().length() > 0) {
            ...
            if (preferences.contains("emailid")) {
                uemail = preferences.getString("emailid", "");
            ...
            if(getPassword.equals(uPassword)){
             ...
             if
                (getEmailId.equals(uemail)&&getPassword.equals(uPassword)){
                String userdetail;


                 startActivity (new Intent(getActivity(),Login.class));
                userdetail = preferences.getString(uPassword,uemail);
                ...
                editor.commit();
                 ...
                 new CustomToast().Show_Toast(getActivity(), view,
                         "Your credentials is dont exist.");
             }
